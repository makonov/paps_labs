...
- **Department** — справочник подразделений, связан со справочником компаний
- **Project** — проекты 
- **RateCalculationData** — данные для расчёта ставок 
- **WorkEffortData** — данные для расчета трудозатраты сотрудников по проектам (помесячно)
...
> Ниже для демонстрации представлена диаграмма с сервисами для расчетов

![Концептуальная диаграмма классов для БД](Концептуальная%20диаграмма%20классов%20для%20БД%20с%20бизнес%20логикой.png)  
